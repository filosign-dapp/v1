...
export default function Navbar() {
  ...
  return (
    <nav className="fixed top-0 gap-2 h-[var(--navbar-height)] w-full bg-background flex items-center justify-between px-[var(--paddingx)] border-b">
      <Link to="/" className="size-8 bg-background border-4 border-foreground shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] flex items-center justify-center shadow-foreground hover:shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[-2px] hover:translate-y-[-2px] transition-all">
